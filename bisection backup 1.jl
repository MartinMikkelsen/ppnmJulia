#This is a small script to test the bisection method
...
println("The value is ", bisection(fun,0.0,1.0)[1])
println(bisection(fun,0.0,1.0)[2])

@benchmark bisection(fun, 0.0, 1.0)