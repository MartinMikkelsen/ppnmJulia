...
# ╔═╡ 1588b9d5-ca03-4520-b433-a2304a1fff30
using DifferentialEquations, Plots, ModelingToolkit, Latexify

# ╔═╡ 2df7ae16-fe74-4efb-8f6b-196c26874066
md"# Lotka-Volterra equations
In this notebook I will solve the Lotka-Volterra equations and test Latexify"

# ╔═╡ 0e359ca1-05e4-4da4-b8ff-7701c21bb7d1
md"First, define a state vector to store the initial conditions. We will refer to this as the state variables. This is done using ModelingToolkit.@variabes"

# ╔═╡ 83f88769-9a5b-4b6d-94ec-f0e552c47408
# Define our state variables: state(t) = initial condition
@variables t x(t)=1 y(t)=1 z(t)=2

# ╔═╡ 95f4c4b7-2f96-4000-a169-834cab020d65
md"We define the parameters as follows"

# ╔═╡ fb571462-fe4f-481f-9195-98d9c949c5c2
# Define our parameters
@parameters α=1.5 β=1.0 γ=3.0 δ=1.0

# ╔═╡ e0da1507-0931-4d79-b5aa-1026393075a3
md"We define the differential operator $D$. Note that the ~ is = using Symbolics.jl"

# ╔═╡ 83fdb955-272f-403f-aeec-bf95ac8ec1db
# Define our differential: takes the derivative with respect to `t`
D = Differential(t)

# ╔═╡ 93584076-1d43-4ac3-ac2d-ce1ad62a865e
...
# ╔═╡ 92f13ceb-6792-4fc4-94f5-04e5e717333b
md"Here we actually solve the differential equations"

# ╔═╡ cad42908-d30d-4ece-ae9c-2c6cab81913f
# Solve the ODE
sol = solve(prob)

# ╔═╡ c1f72ea2-cd18-456f-8f68-0b74132e72bf
md"This can be visualized using the Plots.jl package"

# ╔═╡ d916dc36-cf2a-4d23-9549-cfcb20929d7c
begin
	# Plot the solution
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "581eeb771d35ad55c2e7fc747a63814bdae3bdaa"
